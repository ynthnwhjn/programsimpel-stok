...
@section('pageTitle', 'Laporan Stok Minimum')
        ...
        function PageController($scope, $uibModal, $http, $validation, DTOptionsBuilder, DTColumnBuilder) {
            ...
            $scope.dtOptions = DTOptionsBuilder.newOptions()
                .withOption('ajax', {
                    ...
                    dataSrc: 'data',
                    url: route('laporan_stok_minimum.datasource'),
                    type: 'POST',
                    data: function (d) {
                        d = $scope.filter;
                        console.log(d)
            ...
            $scope.dtColumns = [
                ...
                DTColumnBuilder.newColumn('stok').withTitle('Stok')
                    .withOption('width', 120)
                    .withOption('class', 'dt-right'),
                DTColumnBuilder.newColumn('is_warning_stok_minimum').withTitle('Stok minim')
                    .withOption('width', 120)
                    .withOption('class', 'dt-center')
                    .renderWith(function (data, type, row, meta) {
                        console.log(data)
                        return data ? '<i class="fa fa-exclamation-triangle"></i>' : '';
                    }),
            ];
