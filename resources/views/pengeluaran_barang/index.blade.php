...
<div class="box" ng-controller="PageController">
    <div class="box-header with-border">
        ...
        <div class="btn-group">
            <a href="{{ route('pengeluaran_barang.create') }}" class="btn btn-default">Create</a>
        </div>
    </div>
    <div class="box-body">
    ...
    (function () {
        ...
        function PageController($scope, $uibModal, $http, $validation, DTOptionsBuilder, DTColumnBuilder) {
            ...
            $scope.dtOptions = DTOptionsBuilder.newOptions()
                .withOption('ajax', {
                    dataSrc: 'data',
                    url: route('pengeluaran_barang.index'),
                })
            ...
            $scope.dtColumns = [
                ...
                DTColumnBuilder.newColumn('gudang_asal.nama').withTitle('Gudang'),
                DTColumnBuilder.newColumn(null).withTitle('<i class="fa fa-bars"></i>')
                    .withOption('width', 90)
                    .withOption('class', 'dt-center')
                    .renderWith(function (data, type, row, meta) {
                        return '<a href="'+ route('pengeluaran_barang.edit', row) +'">Edit</a>';
                    }),
            ];
        }
    })();
